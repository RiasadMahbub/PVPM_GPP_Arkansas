...
// Images for the study site arkansasRice2019
...
var collection = collection.filterDate('2019-01-01', '2019-12-31')
...
// batch.Download.ImageCollection.toDrive(withcel_gpp, '2019VPM', 
//                 {scale: 500, 
//                 region: geometry,
//                 type: 'float'})
...
// var z = ee.Image(max
//         .filterMetadata('year', 'equals', 2019).first());
// print(z, "z")
...
Export.image.toDrive({
  image: tmean_mean.clipToCollection(arkansasRice2019),
  description: 'tmean_mean2019',
  folder: '2019Driver',
  scale: 500,
  region: geometry
});
...
Export.image.toDrive({
  image: par_mean.clipToCollection(arkansasRice2019),
  description: 'par_mean2019',
  folder: '2019Driver',
  scale: 500,
  region: geometry
});
...
Export.image.toDrive({
  image: EVI_SG_mean.clipToCollection(arkansasRice2019),
  description: 'EVI_SG_mean2019',
  folder: '2019Driver',
  scale: 500,
  region: geometry
});
...
Export.image.toDrive({
  image: LSWI_SG_mean.clipToCollection(arkansasRice2019),
  description: 'LSWI_SG_mean2019',
  folder: '2019Driver',
  scale: 500,
  region: geometry
});
...
Export.image.toDrive({
  image: pLUEmax2_mean.clipToCollection(arkansasRice2019),
  description: 'pLUEmax2_mean2019',
  folder: '2019Driver',
  scale: 500,
  region: geometry
});
