...
# Assuming LUEmaxGDD is your dataframe
write.csv(LUEmaxGDD, file = "LUEmaxGDD.csv", row.names = FALSE)
...
### save the file for taking it to the computer
# Define the directory path and file name
directory_path <- "/Users/riasadbinmahbub/Library/CloudStorage/Box-Box/Research/Data/VPM/SiteDataSpatialDataVPMplotting"
file_name <- "df_luemaxgdd_modeled.csv"
LUEmaxgddfilename <- "LUEmaxGDD.csv"

# Concatenate the directory path and file name
file_path <- file.path(directory_path, file_name)
file_pathLUEmaxgdd <- file.path(directory_path, LUEmaxgddfilename)

# Save the DataFrame to a CSV file
write.csv(df_luemaxgdd_modeled, file = file_path, row.names = FALSE)
write.csv(LUEmaxGDD, file = file_pathLUEmaxgdd, row.names = FALSE)

print(paste("DataFrame saved successfully to:", file_path))
